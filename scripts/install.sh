...
if ! forge system status | grep -q "forged"; then
    echo "❌ Демон 'forged' не запустился. Пожалуйста, проверьте логи."
    exit 1
fi

echo "✅ 'forge' и 'forged' успешно установлены в $INSTALL_DIR. Демон запущен."

echo "🎉 Установка завершена! Можете использовать команду 'forge up'."
